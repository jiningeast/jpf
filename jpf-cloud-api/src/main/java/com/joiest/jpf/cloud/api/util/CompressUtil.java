...
public class CompressUtil {
    ...
    public static Boolean removeDirFromZipArchive(String file, String removeDir) throws ZipException {
        ...
        if (dirHeader == null) return false;
        ...
        zipFile.removeFile(dirHeader.getFileName());
        return true;
    }
    public static Boolean removeFileFromZipArchive(String file, String fileName) throws ZipException {

        // 创建ZipFile并设置编码
        ZipFile zipFile = new ZipFile(file);
        zipFile.setFileNameCharset("UTF-8");
//        if (!StringUtils.isEmpty(passwd) && zipFile.isEncrypted()) {
//
//            //zipFile.setEncryptFiles(true);
//            //zipFile.setEncryptionMethod(Zip4jConstants.ENC_METHOD_STANDARD);	// 加密方式
...
//        }
        ...
        //if(fileHeader.isFileNameUTF8Encoded()) return false;
    ...
    public static void main(String[] args) {
        ...
        * 压缩
        * */
        //String aa = zip("E:\\test.xlsx");//压缩文件到当前目录 无密码
        //String bb =zip("E:\\test.xlsx","123456");//压缩文件到=》当前目录 指定密码
        String cc =zip("E:\\test.xlsx","E:\\home\\cc.zip",null);//压缩文件=》指定压缩目录 无密码
        //String dd =zip("E:\\test.xlsx","E:\\home\\cc.zip","123456");//压缩文件=》指定压缩目录 指定密码
        //String ee =zip("E:\\wode","E:\\home\\my.zip","123456");//压缩目录=》指定压缩目录 指定密码
...
//		try {
//
//            File[] files = unzip("E:\\test.zip",null); //解压文件到=》当前目录 无密码
//            //File[] files = unzip("E:\\test.zip","E://home","null"); //解压文件到=》指定目录 无密码
//            //File[] files = unzip("E:\\home\\my.zip","123456");//解压文件到=》当前目录 指定密码
//            //File[] files = unzip("E:\\home\\my.zip","E:\\","123456");//解压文件到=》指定目录 指定密码
