...
public class LoginyjController {
    ...
    @ResponseBody
    public String loginyj(HttpServletRequest request)
    {
//        BASE64Encoder encoder = new BASE64Encoder();
        String str = "this is 中华人民共和国";
        Map<String,String> mapJson = new HashMap<>();
        mapJson.put("name","张三");
        mapJson.put("age","16");
//        mapJson.put("base64",encode);
        String json = JsonUtils.toJson(mapJson);
//        new sun.misc.BASE64Encoder().encode(str.getBytes("UTF-8"));
//        String abc = encoder.encode(json.getBytes("UTF-8"));
        String efg = Base64CustomUtils.base64Encoder(json);
        String dddd = "eyJuYW1lIjoi5byg5LiJIiwiYWdlIjoiMTYifQ==";
        String strjson = Base64CustomUtils.base64Decoder(dddd);
        Map<String,String> map = JsonUtils.toObject(strjson, Map.class);
        return efg;
