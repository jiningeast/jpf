...
public class LoginInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (uri.indexOf("index") > -1 || uri.indexOf("login") > -1 || uri.indexOf("unionPayRefundReturn") > -1 || uri.indexOf("cloudTask/testCheckBanks") > -1 || uri.indexOf("cloudCompanyMoney/searchWaitPay") > -1 || uri.indexOf("oss/upload") > -1 || uri.indexOf("/queryBizOrder") > -1|| uri.indexOf("/dobingdata") > -1 ) { // 不需要过滤的地址
