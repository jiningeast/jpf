        ...
        <form id="editForm" method="post" enctype="multipart/form-data" accept="image/gif, image/jpeg,image/jpg, image/png">
            <table cellpadding=3 class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a style="margin-left: 5%;" id="saveBtn_typeName" class="easyui-linkbutton" icon="icon-add" href="javascript:void(0)">编辑</a></td>
                </tr>
                <tr>
                    ...
                    <td><a style="margin-left: 5%;" id="saveBtn_supplierName" class="easyui-linkbutton" icon="icon-add" href="javascript:void(0)">编辑</a></td>
                </tr>
                <tr>
                    ...
                    <td><a style="margin-left: 5%;" id="saveBtn_brandName" class="easyui-linkbutton" icon="icon-add" href="javascript:void(0)">编辑</a></td>
                </tr>
                <tr>
                    <td style="text-align: right;background-color: #f1f1f1;">联系人：</td>
                    <td>
                        <input id="contactName" name="contactName" value="${productOne.contactName}" type="text" style="width:220px" class="easyui-textbox" value="" data-options="required:true" />
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="contactPhone" name="contactPhone" value="${productOne.contactPhone}" type="text" style="width:220px" class="easyui-textbox" value="" data-options="required:true,validType:'phone'" />
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="contactEmail" name="contactEmail" value="${productOne.contactEmail}" type="text" style="width:220px" class="easyui-textbox" value="" data-options="required:true,validType:'email'" />
                    </td>
                    <td></td>
                    <td></td>
                </tr>
            ...
            <table cellpadding=3 class="table table-bordered">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="title" name="title" value="${productOne.title}" type="text"  class="easyui-textbox"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="moneyscope" name="moneyscope" value="${productOne.moneyscope}" type="text" class="easyui-textbox"/>(例：100-1000)
                    </td>
                </tr>
            </table>
        </form>
...
<script>
    ...
    function initData() {
        ...
        $('#supplierName_add').textbox('setValue', "${productOne.supplierName}");
        $('#brandName_add').textbox('setValue', "${productOne.brandName}");
        $('#typeName_add').textbox('setValue', "${productOne.typeName}");
    ...
    $(function () {
        $("#typeId").combobox({
            ...
            onSelect: function () {
                ...
                $('#typeName_add').textbox('setValue', typeName);
            }
        });
        ...
        $("#supplierId").combobox({
            ...
            onSelect: function () {
                ...
                $("#supplierName_add").val(supplierName)
                $('#supplierName_add').textbox('setValue',supplierName);
            }
        });
        ...
        $("#brandId").combobox({
            ...
            onSelect: function () {
                ...
                $("#brandName_add").val(brandName)
                $('#brandName_add').textbox('setValue', brandName);
            }
        });
        ...
        $("#saveBtn_supplierName").linkbutton({
            onClick: function () {
                ...
                var id = $("#supplierId").combobox("getValue");
                ...
                if( !id ){
                    $.messager.alert('消息提示', '请选择[供应商名称]！', 'error');
                    return false;
                }
                var param = {};
        ...
        $("#saveBtn_typeName").linkbutton({
            onClick: function () {
                ...
                var pid = $("#typeId").combobox("getValue");
                if ( !typeName )
                {
                ...
                if( !pid ){
                    $.messager.alert('消息提示', '请选择[商品类型]！', 'error');
                    return false;
                }
                var param = {};
        ...
        $("#saveBtn_brandName").linkbutton({
            onClick: function () {
                ...
                var id = $("#brandId").combobox("getValue");
                if ( !brandName )
                {
                ...
                if ( !id )
                {
                    $.messager.alert('消息提示', '请选择[品牌名称]！', 'error');
                    return false;
                }
                var param = {};
