        ...
        <form id="addForm" method="post">
            ...
            <table cellpadding=3 class="table table-bordered" id="wx" class="paramTable" style="display: none">
                ...
                <tr>
                    ...
                    <td>
                        <input id="wx_merSubMchid" name="wx_merSubMchid" type="text" style="width:220px" class="easyui-textbox" value="" />
                    </td>
                    <td style="text-align: right;background-color: #f1f1f1;">
                        参数2:
                    ...
                    <td>
                        <input id="wx_param2" name="wx_param2" type="text" style="width:220px" class="easyui-textbox" value="" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right;background-color: #f1f1f1;">
