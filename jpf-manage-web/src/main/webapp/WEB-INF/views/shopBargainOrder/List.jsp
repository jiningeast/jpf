        ...
        $(function() {
            ...
            var toolbar = [

                {
                    ...
                    handler:function(){
                        ...
                        $('#edit').window("open").window('refresh', '../shopBargainOrder/audit?orderNo='+rows[0].orderNo+'&type=1').window('setTitle','审核');
                    }
                }
            ];
            ...
            $('#dg').datagrid({
                ...
                columns:[[
                    ...
                    {field:'buyerCustomerNickname',title:'买家昵称',width:'7%'},
                    ...
                    {field:'bankNo',title:'银行卡号',width:'10%'},
