        ...
        $(function() {
            ...
            var toolbar = [

                {
                    ...
                    handler:function(){
                        ...
                        $('#infoDiv').window("open").window('refresh', 'editFansource/page?id='+rows[0].id).window('setTitle','编辑');
                    }
                },
            ...
            $('#dg').datagrid({
                ...
                columns:[[
                    ...
                    {field:'cat',title:'地区',width:'10%'},
                    // {field:'merchName',title:'商户名称',width:'13%'},
                    {field:'mobile',title:'手机号',width:'10%'},
                    {field:'name',title:'姓名',width:'10%'},
                    {field:'created',title:'创建时间',width:'15%',formatter: formatDateStr},
        ...
        <div style="padding:10px 60px 20px 60px">
            <form id="searchForm" method="post">
                <table cellpadding="5" width="75%">
                    <tr>
                        <td>手机号:</td>
                        <td><input id="mobile" name="mobile" class="easyui-textbox" type="text" /></td>
                        <td>名字:</td>
