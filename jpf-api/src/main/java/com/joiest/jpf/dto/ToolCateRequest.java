 ...
 * ToolCateRequest
 */
public class ToolCateRequest {

    public ToolCateRequest() {
    }

    public ToolCateRequest(String method, String host, String path, String appKey, String appSecret, int timeout) {
        this.method = method;
        this.host = host;
        this.path = path;        
        this.appKey = appKey;
