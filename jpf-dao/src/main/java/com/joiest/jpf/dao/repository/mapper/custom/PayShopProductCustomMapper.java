...
public interface PayShopProductCustomMapper {
    /**
     * 根据条件计数
     *
     * @param example
    ...
    List<PayShopProductCustomer> getProductListCustom(Map<String,Object> map);
    Map<String,Long> getProductCountCustom(Map<String,Object> map);
}