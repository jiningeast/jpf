...
public interface PayCloudCompactStaffInterfaceCustomMapper {
    /**
     * 根据条件计数
     *
     * @param example
    ...
    List<PayCloudCompactStaffInterfaceCustom> getUserCompactListCustom(PayCloudCompactStaffExample example);
